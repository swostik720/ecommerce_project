      ...
      <div className="p-6 pt-20">
        ...
        {product ? (
          <>
            ...
            {/* Add to Cart Button */}
            <button
              className="bg-green-500 text-white px-4 py-2 mt-4 mr-2 rounded-lg shadow-md hover:bg-green-600"
            ...
            <button
              className="bg-blue-500 text-white px-4 py-2 mt-4 rounded-lg shadow-md hover:bg-blue-600"
