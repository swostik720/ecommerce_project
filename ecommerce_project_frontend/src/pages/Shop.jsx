...
const Shop = () => {
    ...
    return (
        <div>
            ...
            <div className="flex">
            {/* Sidebar */}
            <div className="w-0.5/4 p-4 border-r  bg-gray-200 h-screen top-0 left-0 pt-20 overflow-y-auto">
            ...
            <div className="w-3/4 p-4 pt-20">
                <div className="grid grid-cols-2 gap-4">
                    {filteredProducts.map((product) => {
                        // Get the category name through the brand
                        const productBrand = brands.find((brand) => brand.id === product.brand_id);
                        const productCategory = productBrand ? brands.find((brand) => brand.id === productBrand.id).category : null;
                        ...
                        return (
                            <div key={product.id} className="border p-4 flex">
                                ...
                                <div className="ml-4 flex flex-col justify-between">
                                    ...
                                    {/* Mapping category name through brand */}
